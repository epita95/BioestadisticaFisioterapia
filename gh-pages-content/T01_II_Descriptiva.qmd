...
## Ejercicio Clínico Rápido — T01

**Contexto:** Un fisioterapeuta mide la flexión de rodilla en 8 pacientes:
112°, 118°, 125°, 122°, 130°, 128°, 119°, 126°

**Preguntas:**
1. Calcula la media ($\bar{x}$), mediana ($Me$) y rango intercuartílico ($RIQ$)
2. ¿Qué medida de tendencia central es más adecuada si hay un outlier de 155°?
3. ¿Cómo clasificarías esta variable (tipo, escala)?

**Soluciones:**
1. $\bar{x}=122.5°$, $Me=123.5°$, $Q_1=118.5°$, $Q_3=127.5°$, $RIQ=9°$
2. La mediana — la media subiría a 126.6° arrastrada por el outlier
3. Cuantitativa continua, escala de razón
