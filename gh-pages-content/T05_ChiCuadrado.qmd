...
1. OR = 35×25/15×25 = 2.33
2. Terapia manual tiene 2.33× más odds de mejorar. Significativo
3. χ² de Pearson (frecuencias esperadas > 5)

```{r}
tabla<-matrix(c(35,25,15,25),2)
chi<-chisq.test(tabla,correct=FALSE)
cat("OR=",round(35*25/(15*25),2)," χ²=",round(chi$stat,2)," P=",round(chi$p.val,4))
```
:::
